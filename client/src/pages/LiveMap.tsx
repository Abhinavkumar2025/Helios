  ...
  return L.divIcon({
    ...
    html: `
      ...
      ">
        ...
        <span style="font-size: 14px; font-weight: bold; color: #fff;">${label}</span>
      </div>
    `,
    iconSize: [32, 32],
    iconAnchor: [16, 16],
...
export const LiveMap: React.FC = () => {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 bg-helios-900/90 p-4 rounded-xl border border-slate-800 backdrop-blur-md">
        <div className="flex items-center gap-2">
          <Filter className="w-4 h-4 text-solar-400" />
